...
build() {
  ...
  local SRC_FILES="-I src/ src/ds/queue/queue.cpp src/ds/tree/nodetype.cpp src/diff/io.cpp src/misc/util.cpp src/diff/derivative.cpp src/ds/tree/tree.cpp src/ds/tree/dump/dump.cpp src/main.cpp src/ds/tree/node.cpp src/error/error.cpp src/diff/context.cpp"
