...
DEFINES="-D _DEBUG -D DISABLE_NEWLINES"
...
SRC_FILES="-I src src/data_structures/queue/queue.cpp src/math/calc.cpp src/data_structures/tree/nodetype.cpp src/io/io.cpp src/misc/util.cpp src/math/diff.cpp src/data_structures/tree/tree.cpp src/data_structures/tree/dump/dump.cpp src/main.cpp src/data_structures/tree/node.cpp src/error/error.cpp"
LIBS="" #empty for now
